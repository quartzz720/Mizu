...
enum {
    ...
    SAY_COULD_NOT_SAVE,
    SAY_START, SAY_PROGRAMS, SAY_SETTINGS, SAY_SHUT_DOWN,
    SAY_SHUT_DOWN_ASK, SAY_NO_PROGRAMS,
    SAY_RUN, SAY_RUN_ASK, SAY_RUN_FAILED, SAY_NO_APPLICATION,
    SAY_FILES, SAY_LANGUAGE, SAY_SOUND, SAY_CONSOLE_COLOURS,
    SAY_KEPT_AT_ONCE, SAY_OPEN,
    /* The file operations Files offers on the right button. */
    SAY_RENAME, SAY_COPY, SAY_DELETE, SAY_COPY_TO, SAY_COPYING,
    SAY_NAME_TAKEN, SAY_OVERWRITE, SAY_ONLY_FILES,
    SAY_CANNOT_RENAME, SAY_CANNOT_COPY, SAY_CANNOT_DELETE, SAY_DELETE_ASK,
    SAY_COUNT
};
