...
static const char* phrases[SAY_COUNT][LANGUAGE_COUNT] = {
    ...
    /* SAY_OPEN           */ { "Open", "Открыть", "Відкрити", "Άνοιγμα" },
    /* SAY_RENAME         */ { "Rename", "Переименовать", "Перейменувати",
                               "Μετονομασία" },
    /* SAY_COPY           */ { "Copy...", "Копировать...", "Копіювати...",
                               "Αντιγραφή..." },
    /* SAY_DELETE         */ { "Delete", "Удалить", "Видалити", "Διαγραφή" },
    /* SAY_COPY_TO        */ { "Copy it where?", "Куда копировать?",
                               "Куди копіювати?", "Αντιγραφή πού;" },
    /* SAY_COPYING        */ { "Copying...", "Копирование...", "Копіювання...",
                               "Αντιγραφή..." },
    /* SAY_NAME_TAKEN     */ { "There is already something called that.",
                               "Здесь уже есть файл с таким именем.",
                               "Тут уже є файл із таким ім'ям.",
                               "Υπάρχει ήδη κάτι με αυτό το όνομα." },
    /* SAY_OVERWRITE      */ { "There is already a file there. Replace it?",
                               "Там уже есть файл. Заменить его?",
                               "Там уже є файл. Замінити його?",
                               "Υπάρχει ήδη αρχείο εκεί. Να αντικατασταθεί;" },
    /* SAY_ONLY_FILES     */ { "Only files for now - a directory is a whole "
                               "tree and that is not written yet.",
                               "Пока только файлы: каталог - это целое дерево, "
                               "и это ещё не написано.",
                               "Поки лише файли: каталог - це ціле дерево, "
                               "і це ще не написано.",
                               "Προς το παρόν μόνο αρχεία." },
    /* SAY_CANNOT_RENAME  */ { "It could not be renamed.",
                               "Переименовать не удалось.",
                               "Перейменувати не вдалося.",
                               "Δεν ήταν δυνατή η μετονομασία." },
    /* SAY_CANNOT_COPY    */ { "It could not be copied. Is the disk full?",
                               "Скопировать не удалось. Возможно, диск полон.",
                               "Скопіювати не вдалося. Можливо, диск повний.",
                               "Δεν ήταν δυνατή η αντιγραφή." },
    /* SAY_CANNOT_DELETE  */ { "It could not be deleted.",
                               "Удалить не удалось.",
                               "Видалити не вдалося.",
                               "Δεν ήταν δυνατή η διαγραφή." },
    /* SAY_DELETE_ASK     */ { "Delete it? There is no way back.",
                               "Удалить? Вернуть будет нельзя.",
                               "Видалити? Повернути буде неможливо.",
                               "Διαγραφή; Δεν υπάρχει επιστροφή." }
};
